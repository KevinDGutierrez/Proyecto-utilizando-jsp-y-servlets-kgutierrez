...
<%@page import="org.kevingutierrez.webapp.model.Producto"%>
            ...
            <thead>
                ...
                <tbody>
                    ...
                    <% 
                        ...
                        <tr>
                            <th class="text-center text-bg-danger  text-white" scope="row"><%=producto.getProductoId()%></th>
                            <td class="text-center text-bg-primary text-white" ><%=producto.getNombreProducto()%></td>
                            <td class="text-center text-bg-primary text-white"><%=producto.getDescripcionProducto()%></td>
                            <td class="text-center text-bg-primary text-white"><%=producto.getMarcaProducto()%></td>
                            <td class="text-center text-bg-primary text-white"><%=producto.getPrecioProducto()%></td>
                            <td class="text-center text-bg-primary"></td>
                        </tr>
                        <% }
                    %>
                </tbody>
